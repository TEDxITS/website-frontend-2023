...
export default async function ArtDetail({ itemId }: { itemId: string }) {
  ...
  const data = itemDetail.data.description;
  return (
    <div className='py-10 sm:mb-16 md:h-screen'>
      <div className='flex items-center justify-center space-x-20 max-md:flex-col max-md:space-x-0 max-md:space-y-10'>
        {itemDetail.data.src && (
          <Image
        ...
        <div
          className={clsxm(
            'space-y-10 max-md:w-4/5 max-md:flex-col max-md:items-center max-md:space-y-5',
