export default function AlumniSection() {
  return (
    <section className='mt-16'>
      <div className='layout mb-14 rounded-md bg-gradient-to-r from-cblue to-cwhite px-20 py-6'>
        <p className='text-center text-3xl'>
          Couldn’t say enough thanks for our{' '}
          <span className='text-4xl font-bold'>139</span> dedicated committees
          and
          <span className='text-4xl font-bold'> 48</span> ambassadors. We
