...
import preEvent1 from '~/images/landing/post-event/adhitia.png';
import story from '~/images/landing/post-event/jehian.png';
import comment1 from '~/images/landing/post-event/ory.png';
        ...
        <div className='mx-auto mt-0 w-11/12 md:mt-16 lg:mt-32 xl:w-10/12'>
          ...
          <div className='lg:flex lg:justify-between'>
            ...
            <div className='mt-10 flex flex-col sm:mt-40 sm:flex-row lg:mt-0'>
              <div className='relative z-50 mx-auto h-max w-full rounded-xl bg-cwhite/50 p-3 sm:-right-4 sm:-top-28 sm:w-72 sm:p-0'>
                <Image
                  src={comment1}
                  className='my-6 rounded-2xl shadow-2xl transition-transform hover:scale-105 sm:m-6'
                  alt='comment'
                  placeholder='blur'
          ...
          <div className='lg:flex lg:justify-between'>
            <div className='sm:relative lg:mx-0 lg:-mt-28 xl:mt-0'>
              ...
              <div className='bg z-30 mx-auto mt-6 flex w-full justify-center rounded-xl bg-cwhite/50 p-5 sm:mt-28 sm:w-96 lg:mx-0 lg:-ml-4 lg:mt-0 lg:w-9/12 xl:ml-0 xl:w-full'>
                <Image
                  src={story}
