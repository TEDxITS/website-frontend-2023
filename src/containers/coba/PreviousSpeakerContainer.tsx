...
export default function PreviousSpeakerContainer() {
  ...
  return (
    <div className='layout relative bg-transparent py-20'>
      <div className='z-10 h-full w-full'>
        <div className='h-full w-full'>
          ...
          />
          <h1 className='relative p-3 font-primary text-5xl capitalize tracking-wide text-cred after:absolute after:bottom-[-5px] after:left-4 after:h-[2px] after:w-1/4 after:bg-cwhite after:content-[""] max-md:text-3xl max-md:after:bottom-1'>
            our previous speaker
          </h1>
          <section className='min-lg:pt-5 bw flex h-full w-full flex-col'>
            <div className='bw flex w-full'>
              <div className='bw  m-auto grid grid-cols-4 gap-10 max-lg:grid-cols-2 max-lg:gap-36 max-md:gap-5 2xl:gap-36'>
                {[
                  {
                    img: speaker_8,
                    link: '#',
            ...
            <div className='bw flex w-full flex-col items-center'>
              <div className='shadow-4xl flex h-36 w-1/3 flex-col items-center justify-evenly rounded-3xl bg-[rgba(255,255,255,.1)] p-7 drop-shadow-lg backdrop-blur max-lg:w-1/2 max-md:w-4/5 md:w-1/2'>
