...
export default function NewThemeContainer() {
  ...
  return (
    <section className='relative rounded-t-[10rem] bg-gradient-to-r from-cblack via-cblue to-cwhite'>
      <div className='noisy h-full w-full rounded-t-[10rem] px-4 py-10 sm:py-14 sm:px-10'>
        <div className='flex h-full w-full flex-col'>
          ...
          <div className='flex h-full w-full flex-col md:flex-row'>
            <div className='relative m-2 mx-auto w-[40%] min-w-[130px] max-w-[250px] drop-shadow-lg sm:sticky sm:top-4 md:m-5 md:ml-10 md:h-full md:w-[250%] md:max-w-[300px] lg:m-5 lg:w-[280%] lg:max-w-[320px] xl:mt-16 xl:ml-9 xl:w-[300%] xl:max-w-[365px] 2xl:ml-16 2xl:w-[350%] 2xl:max-w-[400px]'>
              <Image
                src={todayRocket}
            ...
            <div className='flex h-full flex-col gap-4 px-2 pt-3 md:gap-4 md:px-4 md:pr-6 lg:gap-8 lg:px-12 lg:pt-4 xl:gap-9 xl:px-16 xl:pt-8 xl:pr-20 2xl:px-28 2xl:pt-10'>
              <div className=' rounded-[3rem] bg-cwhite/50 py-7 px-9 shadow-lg'>
