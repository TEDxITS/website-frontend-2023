...
export default function ThemeContainer() {
  ...
  return (
    <div>
      <section className='relative z-20 flex justify-center overflow-x-clip'>
        <Image
          src={grandThemeBg}
        ...
        <Image
          ...
          style={{ objectFit: 'cover' }}
        />
        <div className='absolute flex h-full w-full flex-col py-4 md:pt-7 lg:pt-10 lg:pl-5 xl:max-w-[1560px] xl:px-10 xl:pt-20'>
          ...
          <div className='flex h-full w-full flex-col md:flex-row'>
            ...
            <div className='flex h-full flex-col gap-4 px-2 pt-3 md:gap-4 md:px-4 md:pr-6 lg:gap-8 lg:px-12 lg:pt-4 xl:gap-9 xl:px-16 xl:pt-8 xl:pr-20 2xl:px-28 2xl:pt-10'>
              <div
                className='2xl:rounded[2.8rem] rounded-[1.7rem] bg-cwhite/50 px-4 pt-1 text-center
                drop-shadow-xl min-[320px]:h-28 min-[350px]:h-32 min-[415px]:h-[8.5rem] min-[415px]:h-36 min-[415px]:py-3 min-[550px]:h-[9.5rem]
              ...
              >
                <div
                  className='h-[30%] min-h-fit w-full cursor-pointer rounded-[1.7rem] bg-cwhite/50 px-4 pt-1 font-primary shadow-2xl transition delay-150 
                  ease-in-out hover:-translate-y-1 hover:scale-125 hover:bg-cwhite hover:drop-shadow-2xl md:h-[83%] md:max-h-72 md:px-3
                  md:pt-2 lg:max-h-[340px] lg:min-h-[77%] lg:px-4 lg:pb-[7rem] lg:hover:scale-125 xl:rounded-[2.4rem] xl:px-5 xl:pb-[10rem] 2xl:pt-4'
                  onMouseEnter={() =>
                    setRocket({
                      today: false,
                      tomorrow: true,
                ...
                <div
                  className='h-[30%] min-h-fit w-full cursor-pointer rounded-[1.7rem] bg-cwhite/50 px-4 pt-1 font-primary  drop-shadow-xl transition delay-150 
                  ease-in-out hover:-translate-y-1 hover:scale-125 hover:bg-cwhite hover:drop-shadow-2xl md:h-[83%] md:max-h-72 md:px-3
                  md:pb-9 md:pt-2 lg:max-h-[340px] lg:min-h-[77%] lg:px-4 lg:hover:scale-125 xl:rounded-[2.4rem] xl:px-5 xl:pb-[5.8rem] 2xl:pt-4'
                  onMouseEnter={() =>
                    setRocket({
                      today: false,
                      tomorrow: false,
                ...
                <div
                  className='h-[30%] min-h-fit w-full cursor-pointer rounded-[1.7rem] bg-cwhite/50 px-4 pb-3 pt-1 font-primary drop-shadow-xl 
                  transition delay-150 ease-in-out hover:-translate-y-1 hover:scale-125 hover:bg-cwhite hover:drop-shadow-2xl md:h-[83%] md:max-h-72
                  md:px-3 md:pb-[54px] md:pt-2 lg:max-h-[340px] lg:min-h-[77%] lg:px-4 lg:hover:scale-125 xl:rounded-[2.4rem] xl:px-5 xl:pb-[7rem] 2xl:h-[10.4rem] 2xl:pt-4'
                  onMouseEnter={() =>
                    setRocket({
                      today: false,
                      tomorrow: false,
