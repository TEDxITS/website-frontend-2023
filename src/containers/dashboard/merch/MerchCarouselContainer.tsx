    ...
    <div className='flex h-screen w-full items-center justify-center overflow-hidden'>
      ...
      <div className='flex h-screen w-full items-center justify-center overflow-hidden'>
        ...
        >
          ...
          <div className='flex h-24 w-36 items-center justify-center bg-gradient-to-r from-cwhite via-cblue to-cblack md:h-48 md:w-72'>
            <Image
          ...
          <span
            className={`${
              lastShow == 1 ? 'flex' : 'hidden'
            } rounded-3xl bg-gradient-to-r from-cwhite via-cblue to-cblack px-4 py-1 font-primary text-xs font-bold md:text-lg`}
          >
      ...
      `}
        >
          ...
          <span
            className={`${
              lastShow == 2 ? 'flex' : 'hidden'
            } rounded-3xl bg-gradient-to-r from-cwhite via-cblue to-cblack py-1 px-4 font-primary text-xs font-bold md:text-lg`}
          >
