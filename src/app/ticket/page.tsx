...
import OurPilotsContainer from '@/containers/ticket/OurPilotsContainer';
  ...
  return (
    <div className='relative min-h-screen w-screen overflow-clip'>
      <div className='relative flex h-fit w-full flex-col items-center pt-32 text-white'>
        <div className='flex h-fit w-full flex-col items-center'>
          <h2 className='z-10 font-primary text-sm font-semibold sm:text-lg xl:text-2xl'>
            <span className='text-cred'>TEDx</span>ITS 2023 Main Event
          </h2>
      ...
      <Image
        src={rightBg}
        alt='Right Ornament'
        className='absolute -top-20 -right-28 z-10 hidden w-[360px] sm:block md:-top-24 md:w-[400px] xl:-right-32 xl:w-[450px]'
        placeholder='blur'
      />
      <Image
        src={leftBg}
        alt='Left Ornament'
        className='absolute -bottom-24 -left-72 z-10 hidden w-[750px] sm:block md:-left-96 md:w-[900px] lg:-bottom-32 xl:w-[930px]'
        placeholder='blur'
      />
