...
const benefitsData = [
  {
    imgBg: topLeftBg,
    imgIcon: topLeftIcon,
    desc: 'GAIN INSIGHT INTO THE CONSEQUENCES OF NEGLECTING OUR WORLD',
  },

  {
    imgBg: toprightBg,
    imgIcon: toprightIcon,
    desc: 'IMMERSE YOURSELF IN THOUGHT-PROVOKING ART INSTALLATIONS',
  },

  {
    imgBg: bottomLeftBg,
    imgIcon: bottomLeftIcon,
    desc: 'DISCOVER NEW PERSPECTIVES ON THE UNIMAGINABLE FUTURE',
  },

  {
    imgBg: bottomRightBg,
    imgIcon: bottomRightIcon,
    desc: 'EXPLORE THE FUTURE OF AI AND ITS IMPACT ON HUMANITY',
  },
];
